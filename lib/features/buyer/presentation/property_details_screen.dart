...
import '../../../features/partner/controllers/lead_controller.dart';
import '../controllers/property_details_controller.dart';
import '../../../features/partner/controllers/visit_controller.dart';
import '../../../features/partner/models/request_visit_model.dart';
import '../../../features/partner/models/visit_status.dart';
import '../../../core/network/api_service.dart';
import '../../../core/routes/app_routes.dart';
import '../../../core/storage/secure_storage_service.dart';
import '../../../core/storage/storage_service.dart';

import '../../partner/data/agent_repo.dart';
import '../../partner/data/lead_repository.dart';
import '../../partner/data/visit_repository.dart';
...
class _PropertyDetailsScreenState extends State<PropertyDetailsScreen> {
            ...
            children: [
              Stack(
                ...
                children: [
                        ...
                        children: List.generate(
                          imageUrls.length,
                            ...
                            decoration: BoxDecoration(
                              color: _currentPage == index ? const Color(0xFF007A5E) : Colors.white.withValues(alpha: 0.6),
                  ...
                  // 🔴 LIVE & ⭐ PREMIUM Badges on Top-Left
                  Positioned(
                    top: 14.h,
                    left: 16.w,
                    child: Row(
                      ...
                      children: [
                        ...
                        Container(
                          ...
                          child: Row(
                            mainAxisSize: MainAxisSize.min,
                            children: [
                              Icon(Icons.workspace_premium_rounded, color: Colors.white, size: 13.sp),
                              SizedBox(width: 4.w),
                              Text(
                                'PREMIUM',
                                style: GoogleFonts.poppins(
              ...
              // ================= FLOATING PROPERTY OVERVIEW CARD =================
              Transform.translate(
              ...
              Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    if (controller.hasSpecifications) ...[
                      _buildSpecificationsSection(),
                      SizedBox(height: 16.h),
                    ],
                    if (controller.hasAmenities) ...[
  ...
  Widget _buildFloatingInfoCard(PropertyDetailsController controller) {
    final isUnderConstruction = controller.status.toLowerCase().contains('under');
    final ppsf = controller.property['pricePerSqft']?.toString() ?? '';
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          Row(
            children: [
              ...
              Container(
                ...
                decoration: BoxDecoration(
                  color: isUnderConstruction ? const Color(0xFFFEF3C7) : const Color(0xFFEFFDF5),
                  borderRadius: BorderRadius.circular(6.r),
                  border: Border.all(
                    color: isUnderConstruction ? const Color(0xFFFCD34D) : const Color(0xFF86EFAC),
                    width: 0.8,
                  ),
                ),
                child: Row(
                  ...
                  children: [
                    Container(
                      ...
                      height: 6.w,
                      decoration: BoxDecoration(
                        color: isUnderConstruction ? const Color(0xFFD97706) : const Color(0xFF16A34A),
                        shape: BoxShape.circle,
                      ),
                    ),
                    SizedBox(width: 5.w),
              ...
              if (controller.property['propertyCode'] != null || controller.property['propertyId'] != null) ...[
                const Spacer(),
                Text(
                  '#${controller.property['propertyCode'] ?? controller.property['propertyId']}',
                  style: GoogleFonts.poppins(
                    fontSize: 9.5.sp,
          ...
          Row(
            children: [
              Icon(Icons.location_on_outlined, size: 14.sp, color: const Color(0xFF64748B)),
              SizedBox(width: 4.w),
              Expanded(
                child: Text(
                  controller.address,
          ...
          Row(
            children: [
              _quickStatTile(
                Icons.bed_outlined,
                'Bedrooms',
                controller.bhkLabel.isNotEmpty ? controller.bhkLabel : '2 BHK',
              ),
              SizedBox(width: 8.w),
              _quickStatTile(
                Icons.square_foot_rounded,
                'Super Area',
                controller.sqft.isNotEmpty ? controller.sqft : 'Spacious',
              ),
              SizedBox(width: 8.w),
              _quickStatTile(
                Icons.chair_outlined,
                'Furnishing',
                controller.furnishing.isNotEmpty ? controller.furnishing : 'Standard',
              ),
              SizedBox(width: 8.w),
              _quickStatTile(
                Icons.explore_outlined,
                'Facing',
                (controller.property['facing']?.toString().isNotEmpty ?? false)
                    ? '${controller.property['facing']}'
                    : (controller.property['bathrooms'] != null ? '${controller.property['bathrooms']} Baths' : 'East'),
              ),
            ],
          ),

          if (controller.hasTags) ...[
            SizedBox(height: 10.h),
            _buildTagsWrap(),
          ],
        ],
  ...
  Widget _quickStatTile(IconData icon, String label, String value) {
    return Expanded(
      child: Container(
        ...
        child: Column(
          children: [
            Icon(icon, size: 16.sp, color: const Color(0xFF007A5E)),
            SizedBox(height: 4.h),
            Text(
              value,
              maxLines: 1,
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          Row(
            children: [
              Container(
                ...
                child: Icon(Icons.description_outlined, color: const Color(0xFF007A5E), size: 16.sp),
              ),
              SizedBox(width: 8.w),
              Text(
                'About Property',
          ...
          SizedBox(height: 10.h),
          Text(
            desc.isNotEmpty ? desc : 'No detailed description provided by the seller yet.',
            style: GoogleFonts.poppins(
              fontSize: 12.sp,
  ...
  // 📥 Download Floor Plan Handler
  Future<void> _downloadFloorPlan(String url) async {
    final cleanUrl = url.trim();
    if (cleanUrl.isEmpty) {
      Get.snackbar(
        'Notice',
        'No floor plan file is available to download.',
        snackPosition: SnackPosition.BOTTOM,
    ...
    try {
      Get.snackbar(
        'Downloading',
        'Starting floor plan download...',
        snackPosition: SnackPosition.BOTTOM,
        duration: const Duration(seconds: 2),
        backgroundColor: const Color(0xFF0F2544),
        colorText: Colors.white,
        icon: const Icon(Icons.downloading_rounded, color: Color(0xFF4EE1A0)),
      );
      ...
      if (await canLaunchUrl(uri)) {
        ...
        await SharePlus.instance.share(
          ShareParams(
            text: 'Download Floor Plan Blueprint: $cleanUrl',
            subject: 'Floor Plan Blueprint',
          ),
        );
      }
    } catch (e) {
      Get.snackbar(
        'Download',
        'Could not open download link: $e',
        snackPosition: SnackPosition.BOTTOM,
      );
    }
  }

  // ================= DYNAMIC PROPERTY DETAILS SECTIONS =================

  // 🏷️ Tags Section
  Widget _buildTagsWrap() {
    if (!controller.hasTags) return const SizedBox.shrink();
    return Wrap(
      spacing: 6.w,
      runSpacing: 6.h,
      children: controller.tags.map((tag) {
        return Container(
          ...
          child: Row(
            mainAxisSize: MainAxisSize.min,
            children: [
              Icon(Icons.local_offer_rounded, size: 11.sp, color: const Color(0xFF059669)),
              SizedBox(width: 4.w),
              Text(
                tag,
                style: GoogleFonts.poppins(
  ...
  Widget _buildSpecificationsSection() {
    if (!controller.hasSpecifications) return const SizedBox.shrink();
    final specs = controller.specifications;

    IconData getSpecIcon(String key) {
      final k = key.toLowerCase();
      if (k.contains('project')) return Icons.apartment_rounded;
      if (k.contains('developer')) return Icons.business_rounded;
      if (k.contains('carpet')) return Icons.square_foot_rounded;
      if (k.contains('built')) return Icons.aspect_ratio_rounded;
      if (k.contains('bedroom')) return Icons.bed_rounded;
      if (k.contains('bathroom')) return Icons.bathtub_rounded;
      if (k.contains('balcon')) return Icons.balcony_rounded;
      if (k.contains('facing')) return Icons.explore_rounded;
      if (k.contains('furnish')) return Icons.chair_rounded;
      if (k.contains('parking')) return Icons.local_parking_rounded;
      if (k.contains('floor')) return Icons.layers_outlined;
      if (k.contains('maintenance')) return Icons.home_repair_service_outlined;
      if (k.contains('booking')) return Icons.receipt_long_rounded;
      if (k.contains('sq.ft') || k.contains('price')) return Icons.currency_rupee_rounded;
      if (k.contains('pin')) return Icons.pin_drop_outlined;
      if (k.contains('code') || k.contains('id')) return Icons.tag_rounded;
          ...
          Row(
            children: [
              Container(
                ...
                child: Icon(Icons.dashboard_customize_rounded, color: const Color(0xFF2563EB), size: 16.sp),
              ),
              SizedBox(width: 8.w),
              Text(
              ...
              return SizedBox(
                ...
                child: Container(
                  ...
                  child: Row(
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: [
                      Icon(getSpecIcon(entry.key), size: 16.sp, color: const Color(0xFF007A5E)),
                      SizedBox(width: 8.w),
                      Expanded(
                        child: Column(
                          crossAxisAlignment: CrossAxisAlignment.start,
  ...
  Widget _buildAmenitiesSection() {
    if (!controller.hasAmenities) return const SizedBox.shrink();

    IconData getAmenityIcon(String name) {
      final n = name.toLowerCase();
      if (n.contains('pool') || n.contains('swim')) return Icons.pool_rounded;
      if (n.contains('gym') || n.contains('fit') || n.contains('workout')) return Icons.fitness_center_rounded;
      if (n.contains('secur') || n.contains('guard') || n.contains('cctv')) return Icons.security_rounded;
      if (n.contains('park') || n.contains('garage')) return Icons.local_parking_rounded;
      if (n.contains('garden') || n.contains('lawn') || n.contains('landscape')) return Icons.park_rounded;
      if (n.contains('lift') || n.contains('elevator')) return Icons.elevator_rounded;
      if (n.contains('power') || n.contains('backup') || n.contains('generator')) return Icons.bolt_rounded;
      if (n.contains('club') || n.contains('community')) return Icons.holiday_village_rounded;
      if (n.contains('play') || n.contains('kid') || n.contains('child')) return Icons.child_care_rounded;
      if (n.contains('wifi') || n.contains('internet')) return Icons.wifi_rounded;
      if (n.contains('intercom') || n.contains('phone')) return Icons.phone_in_talk_rounded;
      if (n.contains('fire')) return Icons.fire_extinguisher_rounded;
      if (n.contains('water')) return Icons.water_drop_rounded;
      if (n.contains('gas')) return Icons.local_gas_station_rounded;
      if (n.contains('tennis') || n.contains('court') || n.contains('badminton') || n.contains('sport')) return Icons.sports_tennis_rounded;
      if (n.contains('maintenance') || n.contains('staff')) return Icons.engineering_rounded;
          ...
          Row(
            children: [
              Container(
                ...
                child: Icon(Icons.stars_rounded, color: const Color(0xFF007A5E), size: 16.sp),
              ),
              SizedBox(width: 8.w),
              Text(
                'Amenities & Highlights (${controller.amenities.length})',
                style: GoogleFonts.poppins(
                  fontSize: 14.sp,
                  fontWeight: FontWeight.w700,
                  color: const Color(0xFF0F172A),
            ...
            children: controller.amenities.map((amenity) {
              return Container(
                ...
                child: Row(
                  mainAxisSize: MainAxisSize.min,
                  children: [
                    Icon(getAmenityIcon(amenity), size: 14.sp, color: const Color(0xFF007A5E)),
                    SizedBox(width: 6.w),
                    Text(
                      amenity,
                      style: GoogleFonts.poppins(
  ...
  // 🎬 Video Tour Section (with In-Screen Video Player)
  Widget _buildVideoSection() {
    final hasVid = controller.hasVideo;
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          Row(
            children: [
              Container(
                ...
                child: Icon(Icons.videocam_rounded, color: const Color(0xFFF87171), size: 16.sp),
              ),
              SizedBox(width: 8.w),
              Text(
                'Property Video Tour',
          ...
          Text(
            hasVid
                ? 'Watch the authentic HD video walkthrough directly below:'
                : 'Experience this property with a 360° virtual tour or request an HD video walkthrough directly from our verified partner.',
            style: GoogleFonts.poppins(
              fontSize: 11.sp,
              color: const Color(0xFF94A3B8),
              height: 1.4,
          ...
          if (hasVid) ...[
            _InlinePropertyVideoPlayer(videoUrl: controller.videoUrl),
            SizedBox(height: 10.h),
            InkWell(
              onTap: () => controller.openExternalUrl(controller.videoUrl),
              child: Center(
                child: Row(
                  mainAxisSize: MainAxisSize.min,
                  children: [
                    Icon(Icons.open_in_new_rounded, size: 13.sp, color: const Color(0xFF4EE1A0)),
                    SizedBox(width: 5.w),
                    Text(
                      'Open in External Video App',
                      style: GoogleFonts.poppins(
                        fontSize: 11.sp,
                        fontWeight: FontWeight.w500,
            ...
            Row(
              children: [
                Expanded(
                  child: InkWell(
                    ...
                    child: Container(
                      ...
                      decoration: BoxDecoration(
                        gradient: const LinearGradient(
                          colors: [Color(0xFF007A5E), Color(0xFF00A884)],
                        ),
                        borderRadius: BorderRadius.circular(12.r),
                      ),
                      child: Row(
                        mainAxisAlignment: MainAxisAlignment.center,
                        children: [
                          Icon(Icons.threed_rotation_rounded, color: Colors.white, size: 16.sp),
                          SizedBox(width: 6.w),
                          Text(
                            '360° Tour',
                            style: GoogleFonts.poppins(
                ...
                Expanded(
                  child: InkWell(
                    onTap: () => controller.launchWhatsApp("919876543210"),
                    borderRadius: BorderRadius.circular(12.r),
                    child: Container(
                      padding: EdgeInsets.symmetric(vertical: 11.h),
                      decoration: BoxDecoration(
                      ...
                      child: Row(
                        mainAxisAlignment: MainAxisAlignment.center,
                        children: [
                          Icon(Icons.video_call_rounded, color: const Color(0xFF4EE1A0), size: 16.sp),
                          SizedBox(width: 6.w),
                          Text(
                            'Request Video',
                            style: GoogleFonts.poppins(
  ...
  // 🗺️ Floor Plan Section (with Download Floor Plan Action)
  Widget _buildFloorPlanSection(BuildContext context) {
    final hasPlan = controller.hasFloorPlan;
    final url = controller.floorPlanUrl;
    final isImage = hasPlan &&
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          Row(
            children: [
              Container(
                ...
                child: Icon(Icons.architecture_rounded, color: const Color(0xFF2563EB), size: 16.sp),
              ),
              SizedBox(width: 8.w),
              Text(
              ...
              Container(
                ...
                child: Text(
                  controller.bhkLabel.isNotEmpty ? controller.bhkLabel : 'Architectural Plan',
                  style: GoogleFonts.poppins(
                    fontSize: 9.5.sp,
                    fontWeight: FontWeight.w600,
                    color: const Color(0xFF2563EB),
          ...
          Text(
            hasPlan
                ? 'Approved architectural layout showing room dimensions, openings, and structural boundaries.'
                : 'Architectural layout blueprint with room dimensions, balconies, and carpet area distribution.',
            style: GoogleFonts.poppins(
              fontSize: 11.sp,
              color: const Color(0xFF64748B),
              height: 1.35,
          ...
          if (hasPlan && isImage) ...[
            ...
            Row(
              children: [
                Expanded(
                  child: ElevatedButton.icon(
                    onPressed: () => _downloadFloorPlan(url),
                    icon: Icon(Icons.file_download_rounded, color: Colors.white, size: 16.sp),
                    label: Text(
                      'Download Plan',
                ...
                Expanded(
                  child: OutlinedButton.icon(
                    onPressed: () => _openZoomImageViewer(context, [url], 0),
                    icon: Icon(Icons.zoom_in_rounded, color: const Color(0xFF0F172A), size: 16.sp),
                    label: Text(
                      'Enlarge & Zoom',
              ...
              child: Row(
                children: [
                  Container(
                    ...
                    child: Icon(Icons.picture_as_pdf_rounded, color: const Color(0xFFDC2626), size: 22.sp),
                  ),
                  SizedBox(width: 12.w),
                  Expanded(
                    child: Column(
                  ...
                  ElevatedButton.icon(
                    onPressed: () => _downloadFloorPlan(url),
                    icon: Icon(Icons.file_download_rounded, color: Colors.white, size: 14.sp),
                    label: Text(
                      'Download',
                  ...
                  Row(
                    children: [
                      Container(
                        ...
                        child: Icon(Icons.design_services_rounded, color: const Color(0xFF2563EB), size: 20.sp),
                      ),
                      SizedBox(width: 10.w),
                      Expanded(
                        child: Column(
                          ...
                          children: [
                            Text(
                              '${controller.bhkLabel.isNotEmpty ? controller.bhkLabel : '2 BHK'} Standard Blueprint',
                              style: GoogleFonts.poppins(
                                fontSize: 12.sp,
                                fontWeight: FontWeight.w600,
                                color: const Color(0xFF0F172A),
                            ...
                            SizedBox(height: 2.h),
                            Text(
                              '${controller.sqft.isNotEmpty ? controller.sqft : 'Spacious Area'} · Verified Dimensions',
                              style: GoogleFonts.poppins(
                                fontSize: 10.sp,
                                color: const Color(0xFF64748B),
                              ),
  ...
  // 📜 RERA Legal Verification Section
  Widget _buildReraSection() {
    final hasCert = controller.reraCertificateUrl.isNotEmpty;
    final reraNum = controller.reraNumber.isNotEmpty
        ? controller.reraNumber
        : 'RERA/MP/${(controller.property['city'] ?? 'IND').toString().toUpperCase()}/2026/VERIFIED';
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          SizedBox(height: 8.h),
          Text(
            'This property conforms to Real Estate Regulatory Authority guidelines, verifying clear land title and legal compliance.',
            style: GoogleFonts.poppins(
              fontSize: 11.sp,
          ...
          Container(
            ...
            child: Row(
              children: [
                ...
                IconButton(
                  icon: Icon(Icons.copy_rounded, size: 16.sp, color: const Color(0xFF16A34A)),
                  tooltip: 'Copy RERA ID',
                  onPressed: () {
                    Clipboard.setData(ClipboardData(text: reraNum));
                    Get.snackbar(
                      'Copied',
                      'RERA Number copied to clipboard',
                      snackPosition: SnackPosition.BOTTOM,
          ...
          if (hasCert)
            InkWell(
              onTap: () => controller.openExternalUrl(controller.reraCertificateUrl),
              borderRadius: BorderRadius.circular(10.r),
              child: Container(
                width: double.infinity,
                padding: EdgeInsets.symmetric(vertical: 10.h),
                ...
                child: Row(
                  mainAxisAlignment: MainAxisAlignment.center,
                  children: [
                    Icon(Icons.description_rounded, color: Colors.white, size: 16.sp),
                    SizedBox(width: 6.w),
                    Text(
                      'View RERA Certificate (PDF)',
                      style: GoogleFonts.poppins(
                        fontSize: 12.sp,
                        fontWeight: FontWeight.w600,
                        color: Colors.white,
            ...
            InkWell(
              ...
              child: Container(
                ...
                child: Row(
                  mainAxisAlignment: MainAxisAlignment.center,
                  children: [
                    Icon(Icons.verified_rounded, color: Colors.white, size: 16.sp),
                    SizedBox(width: 6.w),
                    Text(
                      'Request Verified Legal Docs',
                      style: GoogleFonts.poppins(
                        fontSize: 12.sp,
                        fontWeight: FontWeight.w600,
                        color: Colors.white,
  ...
  // 📍 Location & Surroundings Section with Embedded Google Map
      ...
      child: Column(
        ...
        children: [
          Row(
            children: [
              Container(
                ...
                child: Icon(Icons.location_on_rounded, color: const Color(0xFFD97706), size: 16.sp),
              ),
              SizedBox(width: 8.w),
              Text(
          ...
          Row(
            crossAxisAlignment: CrossAxisAlignment.start,
            children: [
              Icon(Icons.place_outlined, size: 16.sp, color: const Color(0xFF64748B)),
              SizedBox(width: 6.w),
              Expanded(
                child: Text(
                  controller.address.isNotEmpty ? controller.address : 'Prime Residential Locality',
                  style: GoogleFonts.poppins(
                    fontSize: 12.sp,
                    color: const Color(0xFF334155),
                    fontWeight: FontWeight.w500,
          ...
          // 🗺️ Embedded Google Map Container with specified Height & Width
          ClipRRect(
              ...
              child: Stack(
                children: [
                  GoogleMap(
                    ...
                    markers: {
                      Marker(
                        markerId: const MarkerId('property_location_marker'),
                        position: targetLatLng,
                        infoWindow: InfoWindow(
                          title: controller.title.isNotEmpty ? controller.title : 'Property Location',
                          snippet: controller.address,
                        ),
                      ),
                    },
                  ...
                  Positioned(
                    ...
                    child: Container(
                      ...
                      child: Row(
                        mainAxisSize: MainAxisSize.min,
                        children: [
                          Icon(Icons.map_rounded, size: 12.sp, color: const Color(0xFF007A5E)),
                          SizedBox(width: 4.w),
                          Text(
                            'Google Maps',
                            style: GoogleFonts.poppins(
          ...
          InkWell(
            ...
            child: Container(
              ...
              child: Row(
                mainAxisAlignment: MainAxisAlignment.center,
                children: [
                  Icon(Icons.directions_rounded, color: const Color(0xFF4EE1A0), size: 18.sp),
                  SizedBox(width: 8.w),
                  Text(
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          SizedBox(height: 14.h),
          const Divider(color: Color(0xFFCBEFE0), height: 1),
          SizedBox(height: 10.h),
          InkWell(
            onTap: () {},
            child: Row(
    ...
    return Column(
      children: [
        Container(
          ...
          decoration: const BoxDecoration(color: Color(0xFFEFF8F5), shape: BoxShape.circle),
            ...
            SizedBox(
              ...
              child: Obx(() {
                ...
                return ElevatedButton(
                  ...
                  style: ElevatedButton.styleFrom(
                    backgroundColor: const Color(0xFF007A5E),
                    disabledBackgroundColor: const Color(0xFF007A5E).withValues(alpha: 0.6),
              ...
              Container(
                ...
                child: Row(
                  children: [
                    CircleAvatar(
                      radius: 22.r,
                      backgroundColor: const Color(0xFF007A5E).withValues(alpha: 0.1),
...
// 🎬 In-Screen Interactive Video Player Widget
class _InlinePropertyVideoPlayer extends StatefulWidget {
  final String videoUrl;
  const _InlinePropertyVideoPlayer({required this.videoUrl});

  @override
  State<_InlinePropertyVideoPlayer> createState() => _InlinePropertyVideoPlayerState();
}

class _InlinePropertyVideoPlayerState extends State<_InlinePropertyVideoPlayer> {
  ...
  bool get _isYouTube {
    final lower = widget.videoUrl.trim().toLowerCase();
    return lower.contains('youtube.com') || lower.contains('youtu.be');
  }

  bool get _isExternalWebVideo {
    if (_isYouTube) return true;
    final lower = widget.videoUrl.trim().toLowerCase();
  ...
  @override
  void didUpdateWidget(covariant _InlinePropertyVideoPlayer oldWidget) {
  ...
  Future<void> _initPlayer() async {
    ...
    // Direct YouTube / Web player URLs cause ExoPlayer format sniffing errors
    // Render the dedicated interactive web card instead
              ...
              child: Container(
                ...
                decoration: BoxDecoration(
                  color: isYt
                      ...
                      : const Color(0xFF007A5E).withValues(alpha: 0.9),
                  borderRadius: BorderRadius.circular(12.r),
                ),
                child: Row(
                  mainAxisSize: MainAxisSize.min,
                  children: [
                    Icon(
                      isYt ? Icons.play_circle_filled_rounded : Icons.videocam_rounded,
                      color: Colors.white,
                      size: 13.sp,
                    ),
                    SizedBox(width: 5.w),
                    Text(
                      isYt ? 'YOUTUBE WALKTHROUGH' : 'VIDEO TOUR',
                      style: GoogleFonts.poppins(
                        fontSize: 9.sp,
                        fontWeight: FontWeight.w700,
                        color: Colors.white,
            ...
            Material(
              ...
              child: InkWell(
                ...
                child: Container(
                  padding: EdgeInsets.all(14.w),
                  decoration: BoxDecoration(
                    color: isYt ? const Color(0xFFFF0000) : const Color(0xFF007A5E),
                    shape: BoxShape.circle,
                    boxShadow: [
                      BoxShadow(
                        color: (isYt ? const Color(0xFFFF0000) : const Color(0xFF007A5E)).withValues(alpha: 0.4),
                        blurRadius: 16,
                        offset: const Offset(0, 4),
                      ),
                    ],
            ...
            Positioned(
              ...
              child: Row(
                ...
                children: [
                  Expanded(
                    child: Text(
                      isYt ? 'Watch authentic tour on YouTube' : 'Watch in external video app',
                      style: GoogleFonts.poppins(
                        fontSize: 11.sp,
                  ...
                  InkWell(
                    ...
                    child: Row(
                      ...
                      children: [
                        ...
                        SizedBox(width: 3.w),
                        Icon(Icons.open_in_new_rounded, size: 12.sp, color: const Color(0xFF4EE1A0)),
                      ],
                    ),
                  ),
                ],
  ...
  Widget build(BuildContext context) {
    ...
    if (_hasError) {
      return Container(
        ...
        child: Column(
          mainAxisAlignment: MainAxisAlignment.center,
          children: [
            Icon(Icons.videocam_off_rounded, color: const Color(0xFFF87171), size: 30.sp),
            SizedBox(height: 8.h),
            Text(
              'Unable to preview video in-app',
            ...
            ElevatedButton.icon(
              ...
              label: Text('Open Video Link', style: GoogleFonts.poppins(fontSize: 11.sp, fontWeight: FontWeight.w600)),
              style: ElevatedButton.styleFrom(
                backgroundColor: const Color(0xFF007A5E),
    ...
    if (!_isInitialized || _videoController == null) {
      return Container(
        ...
        child: const Center(
          child: CircularProgressIndicator(color: Color(0xFF4EE1A0)),
        ),
      );
    }
          ...
          children: [
            GestureDetector(
              onTap: () {
                ...
                if (_showControls && isPlaying) _scheduleHideControls();
              },
                      ...
                      child: Material(
                        ...
                        child: InkWell(
                          ...
                          child: Container(
                            padding: EdgeInsets.all(12.w),
                            decoration: BoxDecoration(
                              color: const Color(0xFF007A5E).withValues(alpha: 0.9),
                              shape: BoxShape.circle,
                              boxShadow: [
                                BoxShadow(
                            ...
                            Row(
                              ...
                              children: [
                                ...
                                IconButton(
                                  ...
                                  icon: Icon(
                                    _videoController!.value.volume > 0 ? Icons.volume_up_rounded : Icons.volume_off_rounded,
                                    color: Colors.white,
                                    size: 16.sp,
                                  ),
                                  onPressed: () {
                                    setState(() {
                                      final newVol = _videoController!.value.volume > 0 ? 0.0 : 1.0;
