...
class _NiwasAiScreenState extends State<NiwasAiScreen> {
  ...
  Widget _buildAiAvatar() {
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        border: Border.all(color: const Color(0xFF0E8570).withValues(alpha: 0.4), width: 1.5),
      ),
      child: Center(
        child: Icon(
          Icons.auto_awesome,
  ...
  Widget _buildSectionDivider() {
    return Row(
      children: [
        const Expanded(child: Divider(color: Color(0xFF1A3854), thickness: 1)),
        Padding(
                    ...
                    Positioned(
                      ...
                      child: GestureDetector(
                        ...
                        child: Container(
                          padding: EdgeInsets.all(5.r),
                          decoration: BoxDecoration(
                            color: const Color(0xFF071B2F).withValues(alpha: 0.7),
                            shape: BoxShape.circle,
                          ),
                          child: Icon(
