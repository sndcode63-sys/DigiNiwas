...
class SellerProfileScreen extends StatelessWidget {
  ...
  Widget _buildProfileCard(BuildContext context, SellerController controller) {
    ...
    return Container(
      ...
      child: Column(
        children: [
          GestureDetector(
            onTap: () => _showPhotoPickerSheet(context, controller),
            child: Stack(
              children: [
                Obx(() {
                  final localPath = controller.sellerAvatarLocalPath.value;
                  final netUrl = controller.sellerAvatarNetworkUrl.value;
  ...
  void _showPhotoPickerSheet(BuildContext context, SellerController controller) {
            ...
            children: [
              ...
              ListTile(
                ...
                leading: Container(
                  ...
                  child: Icon(Icons.camera_alt_rounded, color: const Color(0xFF00C896), size: 20.sp),
                ),
                title: Text(
                  'Take Photo',
                  style: GoogleFonts.poppins(fontSize: 14.sp, fontWeight: FontWeight.w600, color: const Color(0xFF1E293B)),
                ),
                onTap: () async {
                  Navigator.pop(ctx);
                  ...
                  if (image != null) {
                    await controller.updateSellerAvatar(image.path);
                    if (context.mounted) {
              ...
              ListTile(
                ...
                leading: Container(
                  padding: EdgeInsets.all(8.r),
                  decoration: BoxDecoration(
                    color: const Color(0xFF173554).withValues(alpha: 0.12),
                    borderRadius: BorderRadius.circular(10.r),
                  ),
                  child: Icon(Icons.photo_library_rounded, color: const Color(0xFF173554), size: 20.sp),
                ),
                title: Text(
                  'Choose from Gallery',
                  style: GoogleFonts.poppins(fontSize: 14.sp, fontWeight: FontWeight.w600, color: const Color(0xFF1E293B)),
