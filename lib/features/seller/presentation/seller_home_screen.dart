...
class _SellerHomeScreenState extends State<SellerHomeScreen> {
          ...
          children: [
            ...
            Column(
              ...
              children: [
                ...
                GestureDetector(
                  onTap: () => _controller.fetchSellerLocation(),
                  child: Row(
                    mainAxisSize: MainAxisSize.min,
                    children: [
                      Icon(Icons.location_on, color: AppColors.primary, size: 12.sp),
                      SizedBox(width: 3.w),
                      Obx(() => Text(
                        _controller.sellerLocation.value,
                        style: GoogleFonts.poppins(
                          fontSize: 11.sp,
                      ...
                      SizedBox(width: 2.w),
                      Icon(Icons.keyboard_arrow_down_rounded, color: AppColors.textSecondary, size: 14.sp),
                    ],
                  ),
                ),
              ],
    ...
    return Container(
      ...
      child: Row(
        ...
        children: [
          ...
          _navItem(icon: Icons.handshake_outlined, label: 'My Partner', index: 2),
          _navItem(icon: Icons.notifications_none_rounded, label: 'Updates', index: 3),
  ...
  Widget _navItem({required IconData icon, required String label, required int index}) {
    ...
    const activeColor = Color(0xFF165A54);
